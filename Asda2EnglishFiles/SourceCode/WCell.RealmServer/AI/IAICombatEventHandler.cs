...
namespace WCell.RealmServer.AI
{
    ...
    {
        /// <summary>Called on entering combat</summary>
        void OnEnterCombat();

        /// <summary>Called on Brain's owner taking damage</summary>
        ...
        /// <summary>Called on leaving combat</summary>
        void OnLeaveCombat();
        ...
        /// <summary>Called when any Unit in visible range has been killed</summary>
        ...
        /// <summary>Called when the Owner is killed</summary>
        void OnDeath();
