...
namespace WCell.RealmServer.Spells
{
    ...
    {
        /// <summary>The total amount of remaining milliseconds</summary>
        int TimeLeft { get; }
        ...
        /// <summary>The average amplitude between ticks (in ms)</summary>
        int Amplitude { get; }

        /// <summary>The total duration of this Timer (in ms)</summary>
        int Duration { get; }

        /// <summary>The amount of ticks that already passed</summary>
        int Ticks { get; }

        /// <summary>The maximum amount of ticks</summary>
        int MaxTicks { get; }
