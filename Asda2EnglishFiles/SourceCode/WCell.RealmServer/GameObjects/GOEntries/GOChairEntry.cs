...
namespace WCell.RealmServer.GameObjects.GOEntries
{
    public class GOChairEntry : GOEntry
    {
        ...
        /// <summary>The height of the chair</summary>
        public ChairHeight Height
        {
            get { return (ChairHeight) this.Fields[1]; }
        }

        /// <summary>The StandState when sitting in this chair</summary>
        public StandState SitState
        {
            get { return (StandState) (this.Height + 4); }
        }
