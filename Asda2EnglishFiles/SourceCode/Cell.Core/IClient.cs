...
namespace Cell.Core
{
    public interface IClient : IDisposable
    {
        ...
        /// <summary>Asynchronously sends a copy of the given packet</summary>
        /// <param name="packet">An array of bytes containing the packet to be sent.</param>
        ...
        /// <summary>Sends the content of the given segment to the Client.</summary>
