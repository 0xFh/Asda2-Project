...
namespace WCell.Util.Collections
{
    ...
    public class ImmutableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>,
        IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable
    {
        ...
        {
            this._headDictionary = new BaseImmutableDictionary<TKey, TValue>();
        }
        ...
        {
            this._headDictionary = new BaseImmutableDictionary<TKey, TValue>(capacity);
        }

        /// <summary>The number of key/value pairs in the dictionary.</summary>
        public int Count
        {
            get { return this._headDictionary.Count; }
        }

        /// <summary>Whether or not this dictionary is read-only.</summary>
        ...
        {
            this.PromoteChanges(
                (Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>>) (headDictionary =>
                    headDictionary.Add(key, value)));
        }
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.Add(KeyValuePair<TKey, TValue> pair)
        {
            this.PromoteChanges(
                (Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>>) (headDictionary =>
                    headDictionary.Add(pair.Key, pair.Value)));
        }
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.Remove(KeyValuePair<TKey, TValue> pair)
        {
            ...
            this.PromoteChanges(
                (Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>>) (headDictionary =>
                    headDictionary.Remove(pair.Key)));
            return true;
        }
        ...
        {
            return this._headDictionary.ContainsKey(key);
        }
        ...
        {
            return this._headDictionary.GetEnumerator();
        }
        ...
        {
            get { return (ICollection<TKey>) this._headDictionary.Keys; }
        }
        ...
        {
            get { return (ICollection<TValue>) this._headDictionary.Values; }
        }

        private void PromoteChanges(
            Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>> candidateBuilder)
        {
            BaseImmutableDictionary<TKey, TValue> headDictionary;
            do
            {
                headDictionary = this._headDictionary;
            } while (Interlocked.CompareExchange<BaseImmutableDictionary<TKey, TValue>>(ref this._headDictionary,
                         candidateBuilder(this._headDictionary), headDictionary) != headDictionary);
        }
        ...
        {
            return this._headDictionary.TryGetValue(key, out value);
        }
        ...
        {
            get { return this._headDictionary[key]; }
            set
            {
                this.PromoteChanges(
                    (Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>>)
                    (headDictionary => headDictionary.SetValue(key, value)));
            }
        }
    }
}