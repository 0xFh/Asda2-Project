...
{
    /// <summary>Interface for an object pool.</summary>
    /// <remarks>
    /// An object pool holds reusable objects. See zzObjectPoolMgr for more details.
    /// </remarks>
    public interface IObjectPool
    {
        /// <summary>Amount of available objects in pool</summary>
        ...
        /// <summary>Enqueues an object in the pool to be reused.</summary>
        /// <param name="obj">The object to be put back in the pool.</param>
        void Recycle(object obj);

        /// <summary>Grabs an object from the pool.</summary>
