...
{
    public class NestedSimpleFieldDefinition : DataFieldDefinition, INestedFieldDefinition, IDataFieldDefinition,
        IHasDataFieldDefinitions
    {
        /// <summary>The fields of the type the DataField has</summary>
