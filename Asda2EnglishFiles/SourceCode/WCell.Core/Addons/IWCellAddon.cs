...
namespace WCell.Core.Addons
{
    ...
    {
        /// <summary>The culture-invariant name of this Addon</summary>
        string Name { get; }
        ...
        /// <summary>Website (where this Addon can be found)</summary>
        string Website { get; }
        ...
        /// <summary>The localized name, in the given culture</summary>
