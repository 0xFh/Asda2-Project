...
namespace WCell.RealmServer.Spells.Auras
{
	...
	public static partial class AuraHandler
	{
		...
		static AuraHandler()
		{
            ...
            EffectHandlers[(int)AuraType.StateImmunity] = () => new StateImmunityHandler();										// 39
			...
			EffectHandlers[(int)AuraType.CallStabledPet] = () => new CallStabledPetHandler();									
            EffectHandlers[(int)AuraType.WhirlwindEffect] = () => new WhirlwindEffectHandler();									
            EffectHandlers[(int)AuraType.VampiricEffect] = () => new WhirlwindEffectHandler();							
            EffectHandlers[(int)AuraType.Trap] = () => new TrapEffectHandler();										
            EffectHandlers[(int)AuraType.DragonSlayer] = () => new DragonSlayerEffectHandler();							
            EffectHandlers[(int)AuraType.Flashlight] = () => new FlashLightEffectHandler();								
            EffectHandlers[(int)AuraType.SurpriseAttack] = () => new SurpriseEffectHandler();									
            EffectHandlers[(int)AuraType.TimeBomb] = () => new TimeBombEffectHandler();
            EffectHandlers[(int)AuraType.ThunderBolt] = () => new ThunderBoltEffectHandler();									
            EffectHandlers[(int)AuraType.ResurectOnDeathPlace] = () => new ResurectOnDeathPlaceEffectHandler();								
            EffectHandlers[(int)AuraType.ExploitBlood] = () => new ExploitBloodEffectHandler();
            EffectHandlers[(int)AuraType.AbsorbMagic] = () => new AbsorbMagicEffectHandler();	
			 EffectHandlers[(int)AuraType.ExplosiveArrow] = () => new ExplosiveArrowEffectHandler();				
