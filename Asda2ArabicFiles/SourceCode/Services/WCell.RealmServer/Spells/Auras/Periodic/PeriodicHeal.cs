    ...
    public class PeriodicHealHandler : AuraEffectHandler
    {
        protected override void Apply()
        {
            ...
            if (SpellEffect.MiscValueB == 0)
                Owner.Heal((int)(SpellEffect.MiscValue * m_aura.CasterUnit.RandomDamage / 150), m_aura.CasterUnit, m_spellEffect);
            if (SpellEffect.MiscValueB == 1)
                Owner.Heal((int)(SpellEffect.MiscValue * m_aura.CasterUnit.RandomMagicDamage / 150), m_aura.CasterUnit, m_spellEffect);
        }
    }
