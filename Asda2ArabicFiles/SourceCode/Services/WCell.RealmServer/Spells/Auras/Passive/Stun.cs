	...
	public class StunHandler : AuraEffectHandler
	{
		...
		protected override void Apply()
		{
            if (SpellEffect.MiscValueB == 10)
            {
                ...
                m_aura.Auras.Owner.IncMechanicCount(SpellMechanic.Invulnerable);
                m_aura.Auras.Owner.IncMechanicCount(SpellMechanic.Invulnerable_2);
            }
		...
		protected override void Remove(bool cancelled)
		{
            if (SpellEffect.MiscValueB == 10)
            {
                ...
                m_aura.Auras.Owner.DecMechanicCount(SpellMechanic.Invulnerable);
                m_aura.Auras.Owner.DecMechanicCount(SpellMechanic.Invulnerable_2);
            }
