...
namespace WCell.RealmServer.Achievements
{
	...
	public class AchievementCollection
	{
		...
		{
			m_owner = chr;
			ClassSpecificAchievementId[(int) ClassId.NoClass] = 0;
			ClassSpecificAchievementId[(int) ClassId.OHS] = 459;
			ClassSpecificAchievementId[(int) ClassId.Spear] = 465;
			ClassSpecificAchievementId[(int) ClassId.THS] = 462;
			ClassSpecificAchievementId[(int) ClassId.Crossbow] = 458;
			ClassSpecificAchievementId[(int) ClassId.Bow] = 464;
			ClassSpecificAchievementId[(int) ClassId.Balista] = 461;
			ClassSpecificAchievementId[(int) ClassId.AtackMage] = 467;
			ClassSpecificAchievementId[(int) ClassId.SupportMage] = 460;
			ClassSpecificAchievementId[(int) ClassId.HealMage] = 463;
			//??	= 10
