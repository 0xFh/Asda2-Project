...
namespace WCell.RealmServer.Entities
{
	...
	{
		protected IAsda2Weapon m_mainWeapon, m_offhandWeapon, m_RangedWeapon;
		...
		public IAsda2Weapon MainWeapon
		{
			...
			set
			{
				...
				m_mainWeapon = value;
                var mMainWeapon = m_mainWeapon as Asda2Item;
                if (mMainWeapon != null)
                {
                    //(mMainWeapon).OnUnEquip();
                    if (mMainWeapon.Template.IsWeapon)
                    {
                        this.UpdateMainDamage();
                        this.UpdateMainAttackTime();
                    }
                ...
                {
                    var w = m_mainWeapon as IAsda2Weapon;
                    this.UpdateMainDamage();
                    this.UpdateMainAttackTime();
                }
			}
