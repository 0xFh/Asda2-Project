...
namespace WCell.RealmServer.Commands
{
	...
	public class SendRawCommand : RealmServerCommand
	{
		...
		public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
		{
			...
			using (var packet = new RealmPacketOut(opcode))
			{
				...
				((Character)trigger.Args.Target).Client.Send(packet, addEnd: false);
			}
		}
    ...
    public class SetBroadCastRangeCommand : RealmServerCommand
    {
        ...
        protected override void Initialize()
        {
            Init("SetBroadCastRange","Broadcastrange","BCR");
        }

        public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
        {
            WorldObject.BroadcastRange = trigger.Text.NextFloat(50);
        }
    }
    public class GetRangeCommand : RealmServerCommand
    {
        ...
        public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
        {
            ...
            trigger.Reply(string.Format("Range {0}.",trigger.Args.Target.GetDistance(trigger.Args.Character)));
        }
    }
	#endregion
}