...
namespace WCell.RealmServer.Items
{
	public abstract class BaseInventory : IInventory
	{
		...
		public InventoryError TryAdd(Asda2ItemId id, ref int amount, InventorySlot targetSlot, ItemReceptionType reception = ItemReceptionType.Receive)
		{
		...
		/// </summary>
		/// <returns>The result (InventoryError.OK in case that it worked)</returns>
		public InventoryError TryAdd(Asda2ItemId templId, ref int amount, ItemReceptionType reception = ItemReceptionType.Receive)
		{
