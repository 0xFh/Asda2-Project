...
namespace WCell.RealmServer.Items
{
	public class ItemExtendedCostEntry
	{
        ...
        public static ItemExtendedCostEntry NullEntry = new ItemExtendedCostEntry() {
	        ...
	        RequiredItems = new List<RequiredItem>(5) {
                new RequiredItem() {Id = Asda2ItemId.None, Cost = 0},
                new RequiredItem() {Id = Asda2ItemId.None, Cost = 0},
                new RequiredItem() {Id = Asda2ItemId.None, Cost = 0},
                new RequiredItem() {Id = Asda2ItemId.None, Cost = 0},
                new RequiredItem() {Id = Asda2ItemId.None, Cost = 0}
    ...
    public class DBCItemExtendedCostConverter : AdvancedDBCRecordConverter<ItemExtendedCostEntry>
    {
        public override ItemExtendedCostEntry ConvertTo(byte[] rawData, ref int id)
        {
            ...
            var reqItem1 = (Asda2ItemId)rawData.GetUInt32(currentIndex++);
            var reqItem2 = (Asda2ItemId)rawData.GetUInt32(currentIndex++);
            var reqItem3 = (Asda2ItemId)rawData.GetUInt32(currentIndex++);
            var reqItem4 = (Asda2ItemId)rawData.GetUInt32(currentIndex++);
            var reqItem5 = (Asda2ItemId)rawData.GetUInt32(currentIndex++);
