...
namespace WCell.Constants.World
{
	public static class MapBoundaries 
	{
		public static BoundingBox[] GetMapBoundaries()
		{
            ...
            boxes[(int)MapId.Guildwave] = new BoundingBox(new Vector3(28000, 28000, -2048f), new Vector3(28500, 28500, 2048f));
            boxes[(int)MapId.Fantagle] = new BoundingBox(new Vector3(29000, 29000, -2048f), new Vector3(29500, 29500, 2048f));
            boxes[(int)MapId.WindCanyon] = new BoundingBox(new Vector3(30000, 30000, -2048f), new Vector3(30500, 30500, 2048f));
            boxes[(int)MapId.Astrica] = new BoundingBox(new Vector3(31000, 31000, -2048f), new Vector3(31500, 31500, 2048f));
            boxes[(int)MapId.Elysion] = new BoundingBox(new Vector3(32000, 32000, -2048f), new Vector3(32500, 32500, 2048f));
            boxes[(int)MapId.Acanpolis] = new BoundingBox(new Vector3(33000, 33000, -2048f), new Vector3(33500, 33500, 2048f));
            boxes[(int)MapId.Labyrinthos] = new BoundingBox(new Vector3(34000, 34000, -2048f), new Vector3(34500, 34500, 2048f));
           // boxes[(int)MapId.NightValeyElite] = new BoundingBox(new Vector3(36000, 36000, -2048f), new Vector3(36500, 36500, 2048f));
