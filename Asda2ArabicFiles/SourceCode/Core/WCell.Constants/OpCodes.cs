...
namespace WCell.Constants
{
	...
	public enum RealmServerOpCode : uint
	{
        ...
        GuildInfoOnLogin = 4104,
        ClanFlagAndClanNameInfoSelf = 4105,
        GuildMembersInfo = 4107,
        GuildMembersInfoEnded = 4108,
        CreateGuild = 4109,
        GuildCreated = 4110,
        DisolveGuild = 4111,
        GuildDisolved = 4112,
        SendInviteGuild = 4113,
        SendInviteGuiledResponse = 4114,
        JoinMyGuildRequest = 4115,
        LeaveGuild = 4117,
        JoinGuildResponse = 4116,
        YouHaveLeftGuild = 4118,
        
	    KickFromGuild = 4119,
	    YouHaveBeenKickedFromGuild = 4120,
        UpdateGuildInfo = 4121,
        GuildNotification = 4122,
        GuildChatReq = 4123,
        GuildChatRes = 4124,
        SetPrivilegies = 4125,
        PrivilagiesChanged = 4126,
	    ...
	    AnnouncementEdited = 4132,
        WritePublicGuildMemberNote = 4133,
        EditPublicGuildNote = 4134,
	...
	{
        Success = 1,
        WrongLoginOrPass = 2, AccountInUse = 4,    
        CloseClient = 5,
        AccountBanned = 11
