...
namespace WCell.Intercommunication.DataTypes
{
	...
	public class RoleGroupInfo : IRoleGroup
	{
		...
		public static List<RoleGroupInfo> CreateDefaultGroups()
		{
            ...
            groups.Add(new RoleGroupInfo("GA1", 1, RoleStatus.GA1, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("GA2", 1, RoleStatus.GA2, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("BeSan", 1, RoleStatus.Besan, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("Erza", 1, RoleStatus.Erza, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("Fed", 1, RoleStatus.FeDRAaLe, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("Hum", 1, RoleStatus.Hamura, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("lus", 1, RoleStatus.Xluise, false, false, false, false, false, true, new[] {
                    "Guest"
                }, defaultCommands));
            groups.Add(new RoleGroupInfo("Vip", 5, RoleStatus.GA, false, false, false, false, true, true, new[] {
					"Player"
				}, defaultCommands));
            groups.Add(new RoleGroupInfo("EM", 4, RoleStatus.EventManager, false, false, false, false, true, true, new[] {
					"Player"
				}, defaultCommands));
            groups.Add(new RoleGroupInfo("VIP2", 100, RoleStatus.VIP, false, false, false, false, false, true, new[] {
                    "EM"
                }, defaultCommands));
