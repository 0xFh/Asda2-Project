...
namespace WCell.Util.Threading.TaskParallel
{
  ...
  public static class TaskFactoryExtensions
  {
    ...
    public static Task<IList<Task>> TrackedSequence(this TaskFactory factory, params Func<Task>[] functions)
    {
      ...
      factory.Iterate(
        TrackedSequenceInternal(functions,
          tcs));
      return tcs.Task;
    }
      ...
      CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
    {
        ...
        try
        {
          if(enumerator.MoveNext())
          {
            ...
            if(current is Task)
            {
              ...
              Task.Factory.StartNew(() => recursiveBody(null), CancellationToken.None,
      ...
      factory.StartNew(() => recursiveBody(null), CancellationToken.None,
    ...
    public static Task Iterate(this TaskFactory factory, IEnumerable<object> source)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.Iterate(source, null, factory.CancellationToken, factory.CreationOptions,
        factory.GetTargetScheduler());
    }
      ...
      CancellationToken cancellationToken)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.Iterate(source, null, cancellationToken, factory.CreationOptions,
        factory.GetTargetScheduler());
    }
      ...
      TaskCreationOptions creationOptions)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.Iterate(source, null, factory.CancellationToken, creationOptions,
        factory.GetTargetScheduler());
    }
    ...
    public static Task FromAsync(WaitHandle waitHandle)
    {
      ...
      RegisteredWaitHandle rwh = ThreadPool.RegisterWaitForSingleObject(waitHandle,
        (param0, param1) => tcs.TrySetResult(null), null, -1, true);
      ...
      CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
    {
      ...
      return factory.StartNewDelayed(millisecondsDelay, cancellationToken).ContinueWith(
        _ => action(), cancellationToken, TaskContinuationOptions.OnlyOnRanToCompletion,
        scheduler);
    }
      ...
      TaskScheduler scheduler)
    {
      ...
      factory.StartNewDelayed(millisecondsDelay, cancellationToken).ContinueWith(t =>
      {
        if(t.IsCanceled)
        {
      ...
      Func<TResult> function)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.StartNewDelayed(millisecondsDelay, function, factory.CancellationToken,
        factory.CreationOptions, factory.GetTargetScheduler());
    }
      ...
      Func<TResult> function, CancellationToken cancellationToken)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.StartNewDelayed(millisecondsDelay, function, cancellationToken,
        factory.CreationOptions, factory.GetTargetScheduler());
    }
      ...
      TaskScheduler scheduler)
    {
      ...
      Timer timer =
        new Timer(obj => ((TaskCompletionSource<object>) obj).SetResult(null),
          completionSource, millisecondsDelay, -1);
      ...
      Func<object, TResult> function, object state)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.StartNewDelayed(millisecondsDelay, function, state, factory.CancellationToken,
        factory.CreationOptions, factory.GetTargetScheduler());
    }
      ...
      Func<object, TResult> function, object state, CancellationToken cancellationToken)
    {
      if(factory == null)
        throw new ArgumentNullException(nameof(factory));
      return factory.StartNewDelayed(millisecondsDelay, function, state, cancellationToken,
        factory.CreationOptions, factory.GetTargetScheduler());
    }
      ...
      TaskCreationOptions creationOptions, TaskScheduler scheduler)
    {
      ...
      timer = new Timer(obj => ((Task) obj).Start(scheduler), task, millisecondsDelay,
        -1);
      return result.Task;
    }
    ...
    {
      return factory.ContinueWhenAll(tasks,
    ...
    public static Task<Task<TAntecedentResult>> WhenAny<TAntecedentResult>(this TaskFactory factory,
      params Task<TAntecedentResult>[] tasks)
    {
      return factory.ContinueWhenAny(tasks,
