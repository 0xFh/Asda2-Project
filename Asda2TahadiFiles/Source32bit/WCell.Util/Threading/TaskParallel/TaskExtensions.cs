...
namespace WCell.Util.Threading.TaskParallel
{
  ...
  public static class TaskExtensions
  {
    ...
    public static Task<TResult> ContinueWith<TResult>(this Task task, Func<Task, TResult> continuationFunction,
      TaskFactory factory)
    {
      return task.ContinueWith(continuationFunction, factory.CancellationToken,
    ...
    public static Task WithTimeout(this Task task, TimeSpan timeout)
    {
      ...
      Timer timer = new Timer(state => ((TaskCompletionSource<object>) state).TrySetCanceled(),
    ...
    public static Task<TResult> WithTimeout<TResult>(this Task<TResult> task, TimeSpan timeout)
    {
      ...
      Timer timer = new Timer(state => ((TaskCompletionSource<TResult>) state).TrySetCanceled(),
        result, timeout, TimeSpan.FromMilliseconds(-1.0));
      task.ContinueWith(t =>
      {
        timer.Dispose();
