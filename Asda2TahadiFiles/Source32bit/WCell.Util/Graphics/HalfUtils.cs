namespace WCell.Util.Graphics
{
  public static class HalfUtils
  {
    ...
    public static unsafe ushort Pack(float value)
    {
      ...
      uint num3 = num1 & int.MaxValue;
      if(num3 > 1207955455U)
        return (ushort) (num2 | (uint) short.MaxValue);
      if(num3 >= 947912704U)
        return (ushort) (num2 |
                         (ulong) (num3 + -939524096L + 4095L + (num3 >> 13 & 1U) >> 13));
    ...
    public static unsafe float Unpack(ushort value)
    {
      ...
      if((value & -33792) == 0)
      {
        if((value & 1023) != 0)
        {
          ...
          num1 = (uint) ((value & 32768) << 16 | (int) num2 + sbyte.MaxValue << 23 |
                         (int) num4 << 13);
        }
        else
        ...
        num1 = (uint) ((value & 32768) << 16 |
                       (value >> 10 & 31) - 15 + sbyte.MaxValue << 23 | (value & 1023) << 13);
