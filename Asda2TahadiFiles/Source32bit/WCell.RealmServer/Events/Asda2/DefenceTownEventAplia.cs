  ...
  internal class DefenceTownEventAplia : DeffenceTownEvent
  {
    ...
    protected override void InitMovingPaths()
    {
      AddMovingPath(_map).Add(88, 260).Add(89, 261).Add(90, 263).Add(91, 263).Add(91, 264).Add(92, 266)
        ...
        .Add(87, 456);
      AddMovingPath(_map).Add(213, 396).Add(211, 396).Add(210, 396).Add(209, 396).Add(208, 396)
        ...
        .Add(129, 409).Add(128, 410).Add(sbyte.MaxValue, 410).Add(126, 410).Add(125, 411).Add(123, 412)
      ...
      AddMovingPath(_map).Add(70, 346).Add(70, 348).Add(70, 349).Add(70, 351).Add(70, 353).Add(71, 354)
        ...
        .Add(113, 473);
      AddMovingPath(_map).Add(212, 401).Add(211, 401).Add(209, 401).Add(207, 401).Add(206, 401)
        ...
        .Add(129, 383).Add(sbyte.MaxValue, 382).Add(125, 382).Add(123, 381).Add(122, 381).Add(120, 380)
      ...
      AddMovingPath(_map).Add(72, 345).Add(72, 346).Add(72, 348).Add(72, 350).Add(73, 352).Add(73, 354)
        ...
        .Add(110, 465);
      AddMovingPath(_map).Add(94, 263).Add(95, 264).Add(96, 265).Add(97, 266).Add(98, 267).Add(98, 268)
      ...
      AddMovingPath(_map).Add(134, 391).Add(134, 393).Add(134, 395).Add(135, 397).Add(135, 398)
        .Add(134, 400).Add(134, 401).Add(133, 403).Add(132, 405).Add(131, 406).Add(130, 408).Add(129, 409)
        .Add(sbyte.MaxValue, 410).Add(126, 411).Add(124, 412).Add(123, 412).Add(121, 413).Add(120, 413)
    ...
    {
      get { return (int) (200.0 * _difficulty); }
    }

    protected override int EventItemsTotal
    {
      get { return (int) (100.0 * _difficulty); }
    }

    protected override void InitMonsterSpawn(float amountMod)
    {
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 1, 18, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 50, 6, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 90, 3, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 120, 25, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type2LeafEdgeOfFaith, 150, 30, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 181, 18, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 240, 6, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 270, 3, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 280, 36, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 325, 12, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 361, 24, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 420, 12, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 460, 6, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 480, 30, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 520, 15, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 541, 30, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 600, 18, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 640, 12, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.BossViter, 650, 1, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 670, 24, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 690, 18, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 720, 36, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 780, 24, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 810, 18, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.BossViter, 820, 1, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.BossCommanderGeurantion, 830, 1, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 840, 36, amountMod, BrainState.DefenceTownEventMove);
      ...
      AddSpawnEntry(NpcCustomEntryId.Type3PatchCatOfCourage, 880, 24, amountMod,
        BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type4DecronTroops, 900, 18, amountMod, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.BossQueenKaiya, 950, 1, 1f, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.Type1FieldWolf, 960, 5, 1f, BrainState.DefenceTownEventMove);
      AddSpawnEntry(NpcCustomEntryId.BossBlackEagle, 970, 1, 1f, BrainState.DefenceTownEventMove);
