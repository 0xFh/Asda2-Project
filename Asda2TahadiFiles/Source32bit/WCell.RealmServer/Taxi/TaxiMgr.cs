...
namespace WCell.RealmServer.Taxi
{
  ...
  public static class TaxiMgr
  {
    ...
    public static PathNode GetNearestTaxiNode(Vector3 pos)
    {
      ...
      foreach(PathNode pathNode2 in PathNodesById)
      {
        if(pathNode2 != null)
        {
    ...
    public static PathVertex GetVertex(int id)
    {
      ...
      TaxiVertexReader.Entries.TryGetValue(id, out pathVertex);
      return pathVertex;
    }
    ...
    internal static void InterpolatePosition(Unit unit, int elapsedTime)
    {
      ...
      else
      {
        ...
        Vector3 newPos = pathVertex1.Pos + (pathVertex2.Pos - pathVertex1.Pos) * num /
                         pathVertex2.TimeFromPrevious;
        unit.Map.MoveObject(unit, ref newPos);
      }
    }
  }
}