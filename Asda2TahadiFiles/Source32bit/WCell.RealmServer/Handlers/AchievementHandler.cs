...
namespace WCell.RealmServer.Handlers
{
  ...
  public static class AchievementHandler
  {
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_ALL_ACHIEVEMENT_DATA,
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_ACHIEVEMENT_EARNED, 16))
      {
    ...
    public static RealmPacketOut CreateAchievementEarnedToGuild(uint achievementEntryId, Character chr)
    {
      ...
      realmPacketOut.Write(chr.EntityId);
    ...
    public static void SendAchievmentStatus(AchievementProgressRecord achievementProgressRecord, Character chr)
    {
      using(RealmPacketOut realmPacketOut =
        new RealmPacketOut(RealmServerOpCode.SMSG_CRITERIA_UPDATE, 36))
      {
        realmPacketOut.WriteUInt(achievementProgressRecord.AchievementCriteriaId);
        realmPacketOut.WritePackedUInt64(achievementProgressRecord.Counter);
        chr.EntityId.WritePacked(realmPacketOut);
