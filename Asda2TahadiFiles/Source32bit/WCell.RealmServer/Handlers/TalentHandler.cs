...
namespace WCell.RealmServer.Handlers
{
  public static class TalentHandler
  {
    ...
    public static void HandleRemoveGlyph(IRealmClient client, RealmPacketIn packet)
    {
      ...
      SendTalentGroupList(activeCharacter.Talents);
    }
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.MSG_TALENT_WIPE_CONFIRM, 12))
      {
