...
namespace WCell.RealmServer.Handlers
{
  public static class BattlegroundHandler
  {
    public static void HandleBattlemasterHello(IRealmClient client, RealmPacketIn packet)
    {
      ...
      if(bm == null || !bm.NPCFlags.HasFlag(NPCFlags.BattleMaster))
        return;
    ...
    {
      using(RealmPacketOut packet =
        new RealmPacketOut(RealmServerOpCode.SMSG_BATTLEGROUND_PLAYER_JOINED, 8))
      {
    ...
    {
      using(RealmPacketOut packet =
        new RealmPacketOut(RealmServerOpCode.SMSG_BATTLEGROUND_PLAYER_LEFT, 8))
      {
