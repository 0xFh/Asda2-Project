...
namespace WCell.RealmServer.Handlers
{
  public static class PetHandler
  {
    ...
    public static void HandleNameQuery(IRealmClient client, RealmPacketIn packet)
    {
      ...
      if(npc == null)
        return;
      SendName(activeCharacter, npc.PetNumber, npc.Name, npc.PetNameTimestamp);
    }
    ...
    public static void HandleRename(IRealmClient client, RealmPacketIn packet)
    {
      ...
      if(reason == PetNameInvalidReason.Ok)
        return;
      SendNameInvalid(activeCharacter, reason, name);
    }
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_TAME_FAILURE, 1))
      {
    ...
    public static void SendPetGUIDs(Character chr)
    {
      ...
      {
        using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_GUIDS, 12))
        {
          packet.Write(0);
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_SPELLS, 8))
      {
        packet.Write(0L);
        receiver.Send(packet, false);
      }
    ...
    public static void SendVehicleSpells(IPacketReceiver receiver, NPC vehicle)
    {
      ...
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_SPELLS, 18))
      {
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_REMOVED_SPELL, 4))
      {
        packet.Write(spell);
        receiver.Send(packet, false);
      }
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_NAME_QUERY_RESPONSE,
        9 + name.Length))
      {
        packet.Write(petId);
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_ACTION_SOUND, 12))
      {
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_RENAMEABLE, 0))
        receiver.Send(packet, false);
    }

    public static void SendPetBroken(IPacketReceiver receiver)
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_PET_BROKEN, 0))
        receiver.Send(packet, false);
    }
    ...
    {
      using(RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SMSG_STABLE_RESULT, 1))
      {
