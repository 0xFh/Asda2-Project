...
namespace WCell.RealmServer.Global
{
  public class InstancedMap : Map
  {
    ...
    public bool IsPVPArea
    {
      get
      {
        if(m_MapTemplate.Type != MapType.Battleground)
          return m_MapTemplate.Type == MapType.Arena;
        return true;
      }
    }
    ...
    public void TeleportInside(Character chr, Vector3 pos)
    {
      ...
      chr.SendSystemMessage("Welcome to {0} #{1} (created at {2})", (object) Name, (object) InstanceId,
        (object) m_creationTime.ToString());
    }
