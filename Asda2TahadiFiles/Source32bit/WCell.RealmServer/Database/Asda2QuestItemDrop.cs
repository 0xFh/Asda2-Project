...
{
  [ActiveRecord(Access = PropertyAccess.Property, Table = "asda2QuestItemDrop")]
  public class Asda2QuestItemDrop : WCellRecord<Asda2QuestItemDrop>
  {
    ...
    [Property(NotNull = true)]
    public int questitemid6 { get; set; }
