...
namespace WCell.RealmServer.Guilds
{
  ...
  public class GuildEventLogEntry : ActiveRecordBase<GuildEventLogEntry>
  {
    ...
    {
      return ActiveRecordBase<GuildEventLogEntry>.FindAll(CreatedOrder,
        (ICriterion) Restrictions.Eq("m_GuildId", (int) guildId));
    }
    ...
    public GuildEventLogEntryType Type { get; set; }

    [Property(NotNull = true)]
    public int Character1LowId { get; set; }

    [Property(NotNull = true)]
    public int Character2LowId { get; set; }
