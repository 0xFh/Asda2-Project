...
namespace WCell.RealmServer.Looting
{
  ...
  public struct LootRollEntry : IComparable
  {
    ...
    {
      return m_num + (m_type == LootRollType.Need ? 100 : 0);
    }

    public override bool Equals(object obj)
    {
      if(obj is LootRollEntry && ((LootRollEntry) obj).m_type == m_type)
        return ((LootRollEntry) obj).m_num == m_num;
      return false;
    }
