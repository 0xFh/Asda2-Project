...
namespace WCell.RealmServer.Items
{
  public class ItemEnchantmentConverter : AdvancedDBCRecordConverter<ItemEnchantmentEntry>
  {
    public override ItemEnchantmentEntry ConvertTo(byte[] rawData, ref int id)
    {
      ...
      enchantmentEntry1.Id = (uint) (id = GetInt32(rawData, 0));
      enchantmentEntry1.Charges = GetUInt32(rawData, 1);
      enchantmentEntry1.Description = GetString(rawData, 14);
      enchantmentEntry1.Effects = new ItemEnchantmentEffect[3];
      for(int index = 0; index < 3; ++index)
      {
        ItemEnchantmentType uint32 = (ItemEnchantmentType) GetUInt32(rawData, 2 + index);
        if(uint32 != ItemEnchantmentType.None)
        {
          ...
          enchantmentEffect.MinAmount = GetInt32(rawData, 5 + index);
          enchantmentEffect.MaxAmount = GetInt32(rawData, 8 + index);
          enchantmentEffect.Misc = GetUInt32(rawData, 11 + index);
        }
      }

      ArrayUtil.Prune(ref enchantmentEntry1.Effects);
      int num1 = 31;
      ...
      int field2 = num2;
      int num3 = field2 + 1;
      int uint32_2 = (int) GetUInt32(data2, field2);
      ...
      int field4 = num4;
      int num5 = field4 + 1;
      uint uint32_4 = GetUInt32(data4, field4);
      if(uint32_4 > 0U)
      ...
      enchantmentEntry1.RequiredSkillAmount = GetInt32(rawData, field6);
