...
namespace WCell.RealmServer.Misc
{
  ...
  public class BugReport : WCellRecord<BugReport>
  {
    ...
    public static BugReport CreateNewBugReport(string type, string content)
    {
      ...
      bugReport._id = (int) _idGenerator.Next();
    ...
    {
      return string.Format("{0} - ID : {1}, Type : {2}, Content : {3}, Created : {4}", (object) GetType(),
        (object) _id, (object) _type, (object) _content, (object) _reportDate);
    }
  }
}