namespace WCell.Constants.Items
{
  public enum ItemSubClass
  {
    ...
    WeaponStaff = 10, // 0x0000000A
    WeaponFist = 13, // 0x0000000D
    WeaponMisc = 14, // 0x0000000E
    WeaponDagger = 15, // 0x0000000F
    WeaponThrown = 16, // 0x00000010
    WeaponCrossbow = 18, // 0x00000012
    WeaponWand = 19, // 0x00000013
    WeaponFishingPole = 20 // 0x00000014
  }
}