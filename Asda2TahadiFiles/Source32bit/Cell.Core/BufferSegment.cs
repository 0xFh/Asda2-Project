  ...
  public class BufferSegment
  {
    ...
    public byte[] SegmentData
    {
      get
      {
        ...
        System.Buffer.BlockCopy(Buffer.Array, Offset, numArray, 0, Length);
        return numArray;
      }
    }
    ...
    {
      System.Buffer.BlockCopy(bytes, offset, Buffer.Array, Offset + offset,
        bytes.Length - offset);
    }
    ...
    {
      System.Buffer.BlockCopy(Buffer.Array, Offset, segment.Buffer.Array,
