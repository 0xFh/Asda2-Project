...
namespace WCell.Core
{
  public class AsdaStoryTextDecoder
  {
    ...
    public static string GetString(byte[] data, int startIndex, int count)
    {
      ...
      Array.Copy(data, startIndex, msg, 0, count);
      return Decode(msg);
    }
    ...
    public static byte[] Encode(string msg)
    {
      ...
      foreach(char ch in msg)
      {
        ...
        {
          case '0':
            EncodeData.WriteByte(48);
            break;
          case '1':
            EncodeData.WriteByte(49);
            break;
          case '2':
            EncodeData.WriteByte(50);
            break;
          case '3':
            EncodeData.WriteByte(51);
            break;
          case '4':
            EncodeData.WriteByte(52);
            break;
          case '5':
            EncodeData.WriteByte(53);
            break;
          case '6':
            EncodeData.WriteByte(54);
            break;
          case '7':
            EncodeData.WriteByte(55);
            break;
          case '8':
            EncodeData.WriteByte(56);
            break;
          case '9':
            EncodeData.WriteByte(57);
            break;
          case ':':
            EncodeData.WriteByte(58);
            break;
          default:
            if(RuChars.Contains(ch))
            {
              int index = Array.IndexOf(RuChars, ch);
              EncodeData.WriteByte(RuEncode[index]);
              break;
            }

            EncodeData.WriteByte(Encoding.ASCII.GetBytes(new char[1]
            {
              ch
            })[0]);
            break;
